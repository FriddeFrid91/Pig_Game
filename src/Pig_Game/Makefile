...
pyreverse:
	...
	pyreverse *.py -o html -d doc/pyreverse
# ---------------------------------------------------
#	ot -Thtml classes.dot -o doc/pyreverse/classes.html
#	ot -Thtml packages.dot -o doc/pyreverse/packages.html
#	m -f classes.dot packages.dot
